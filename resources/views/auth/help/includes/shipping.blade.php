        ...
        <div class="baohang">
            ...
            <div class="grid wide">
                <div class="bao-hanh-main">
                    <span style="font-size: 19px;">HIỆN CÓ 3 HÌNH THỨC THANH TOÁN CHO KHÁCH HÀNG LỰA CHỌN:</span>
                    ...
                    <span style="margin-top: 10px;">0372***568 hoặc gởi tin nhắn vào fanpage:
                        https://www.facebook.com/TCZnn.02/ để được hỗ trợ xác nhận thanh toán. Sau
                    ...
                    <span style="margin-top: 10px;">Sau khi quý khách hoàn tất đặt hàng, bộ phận
                        Chăm sóc khách hàng sẽ gọi điện cho quý khách để xác nhận. Sau
