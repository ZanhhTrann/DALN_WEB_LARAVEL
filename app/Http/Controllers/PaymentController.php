...
class PaymentController extends Controller
{
    ...
    public function Pay(Request $request){
        ...
        $shippingSelect = $request->input('shippingSelect');
        session(['payment'=>['UCids' => $selectedUCids, 'select' => $shippingSelect]]);
        return  response()->json(['redirectUrl' => route('payView')]);
    }
    public function payView(){
        // dd(session('payment'));
        return redirect()->route('pages.index',['page'=>'payment']);
    }
    ...
    public function payment(Request $request){
        ...
        foreach ($cartOrders as $value) {
            $product=$prod->getProductbyId($value->Pid);
